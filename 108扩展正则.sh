...
##################
egrep "go*g" 105regular_express.txt
#0以上
egrep "go+g" 105regular_express.txt
#1以上
egrep "go?g" 105regular_express.txt
...
egrep "gog|aa" 105regular_express.txt

egrep "g(oo|la)g" 105regular_express.txt

echo "AxyxyCzxyzxyzCxyz1234" | egrep "A(xy)+C"
echo "AxyzxyzxyzxyzC1234" | egrep "A(xyz)+C"

grep -n "g[lp]g" 105regular_express.txt
grep -nE "g(l|p)g" 105regular_express.txt
#grep -n "g(l|p)g" 105regular_express.txt
#最下面这个不行啊，小括号是扩展用法
